...
class _BurgerScreenState extends State<IceCreamScreen> {
  Color inactiveColor = Colors.white30;
  Color activeColor = Colors.white;
  List<ItemCard> sliders = [
    ItemCard(
      name: 'Ice Cream',
      fullName: 'Classic Ice Crema',
      price: '100',
      image: Image(
        image: Svg(
          'assets/images/ice_cream.svg',
        ),
      ),
    ...
    ItemCard(
      name: 'Bar Ice',
      fullName: 'Classic Bar Ice',
      price: '120',
      image: Image.asset('assets/images/ice2.png'),
      colour: Colors.redAccent[100],
    ),
    ItemCard(
      name: 'Cup Ice Cream',
      fullName: 'Classic Cup Ice Cream',
      price: '250',
      image: Image(
        image: Svg(
          'assets/images/cup_ice.svg',
        ),
      ),
      colour: Colors.redAccent[100],
    ),
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        backgroundColor: kICscreenColor,
        body: Column(
          children: <Widget>[
            Center(
              child: Container(
